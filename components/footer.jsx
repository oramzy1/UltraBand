...
export default function Footer() {
    return (
        <footer className="bg-black text-gray-300  overflow-hidden z-0">
            <div className="container mx-auto py-10 px-9 grid grid-cols-1 md:grid-cols-4 gap-7">
                {/* Brand / Logo */}
                <div>
                    {/* Logo */}
                    <Link href="/" className="flex items-center space-x-2 animate-pulse">
            ...
            {/* Divider */}
            <div className="mt-10 pt-6 text-center text-sm flex flex-col text-gray-500">
                Copyrights{" "}
                <Link
                    href="/"
                    className="text-purple-400 hover:underline"
                >2025 Ultraband Music Entertainment
                </Link>
                <div >
                    Designed by  {" "}
                    <Link target="_blank" href={'https://oramabo-gift-diepriye.vercel.app'}>
                        Oramzy
                    </Link>
                </div>
            </div>
